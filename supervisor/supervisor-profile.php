...
if (!empty($_POST['edit_student']))
{
    ...
    if (!$errors){
        ...
        header('Location: supervisor-show.php');
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                        <a class="nav-link" href="supervisor-summary.php">Tổng kết</a>
                        </li>
                        <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="supervisor-profile.php">Hồ sơ cá nhân</a>
                        </li>                       
                        </li>
                        <li class="nav-item">
