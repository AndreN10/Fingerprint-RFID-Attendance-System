...
// echo gettype( intval((new DateTime('first day of next month'))->diff(new DateTime())->format('%a days')) );
$daysRemain = intval((new DateTime('first day of next month'))->diff(new DateTime())->format('%a days'));
// echo ("Days remain $daysRemain ");
...
foreach ($result_4 as $key => $author4) {
    if ($daysRemain == $daysInMonth && $author4['isReset'] == 0) {
        // Câu truy sửa
            $sql = "
            UPDATE tongket SET
            presentcount = '0',
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="summary.php">Tổng kết</a>
                    </li>
                    <li class="nav-item">
            ...
            <table class="table table-striped table-borderless table-hover caption-top table2excel">
                ...
                <thead class="#">
                    <tr>
                        ...
                        <!--<th style="color:Crimson">Late Count</th>    -->
                        <!-- <th style="color:Crimson">Total Late Time</th>                            -->
                    </tr>
                </thead>
                ...
                <tbody>
                    <?php foreach ($result_4 as $key => $author4) { ?>
                        <tr>
                            ...
                            <td><?php
                                foreach ($result_5 as $key5 => $author5) {
                                    //result 4 tong ket, result 5 profile
                                    if ($author5['id'] == $author4['id']) {
                                        echo $author4['presentcount'];
                                    }
                                }
